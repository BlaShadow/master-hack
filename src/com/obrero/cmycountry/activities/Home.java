...
public class Home extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<DrawerItem> entries = new ArrayList<DrawerItem>(1);
        entries.add(new DrawerItem(R.drawable.home,"Home"));
        entries.add(new DrawerItem(R.drawable.pointer,"Places"));
        entries.add(new DrawerItem(R.drawable.eath,"Path"));
        entries.add(new DrawerItem(R.drawable.recomendations,"Recomentadions"));
        entries.add(new DrawerItem(R.drawable.map,"Map"));
