...
public class WallpaperService extends Service {
    ...
    public Bitmap getCurrentImage(){
        Log.d(TAG,"getImage"+currentIndex);
        if(currentIndex==1){
            drawable = getResources().getDrawable(R.drawable.image_11);
        }
        else if(currentIndex==2){
            drawable = getResources().getDrawable(R.drawable.image_7);
        }
        else{
            drawable = getResources().getDrawable(R.drawable.image_9
            );
        }
        return ((BitmapDrawable) drawable).getBitmap();
    }
